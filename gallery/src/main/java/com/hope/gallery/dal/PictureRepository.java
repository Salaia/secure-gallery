...
import com.hope.gallery.exception.ValidationExceptionCustom;
...
public class PictureRepository {
    ...
    public PictureMeta create(PictureMeta picture) throws ValidationException {
        ...
        String sql = "insert into sgallery.pictures(owner_id, file_name, file_size, uploaded) " +
    ...
    public PictureMeta findPictureMetaById(Long id) {
        ...
        final String sql = "select * from sgallery.pictures where PICTURE_ID = ?";
    ...
    public void checkOwnershipByPictureName(Long ownerId, String fileName) {
        final String sql = "select COUNT(picture_id) from sgallery.pictures where owner_id = ?" +
                " AND file_name = ?";
    ...
    public Long getFileSize(Long ownerId, String filename) {
        final String sql = "select file_size from sgallery.pictures where owner_id = ?" +
                " AND file_name = ?";
    ...
    public List<PictureMeta> findPictureMetasForOwner(Long ownerId, LocalDateTime dateFrom, LocalDateTime dateTo,
        ...
        final String sql = "select * from sgallery.pictures" + whereState;
